...
public class HomPageUI {
    public static final String COLUMN_TEXTBOX_BY_NAME = "xpath=//a[@name='email']//ancestor::tr/following-sibling::tr//input[@name='email']";
    ...
    public static final String DYNAMIC_ROW_VALUES = "xpath=//td[@data-key='females' and text()='%s']/following-sibling::td[@data-key='country' and text()='%s']" +
