...
public class Topic_07_Hard_Assert {
    ...
    public void TC_01_Login_Empty_Email_Password() {
        ...
        Assert.assertFalse(driver.findElement(By.xpath("//button[@title='Subscribe']")).isDisplayed());
        ...
        Assert.assertFalse(driver.findElement(By.xpath("//a[@title='Create an Account']")).isDisplayed());
